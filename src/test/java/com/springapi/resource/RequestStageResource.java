...
import com.springapi.service.RequestStageService;
...
public class RequestStageResource {
	...
	@PostMapping
	public ResponseEntity<RequestStage> save(@RequestBody RequestStage requesteStage) {
		RequestStage createdRequestStage = requestStageService.save(requesteStage);
